...
template <class T> Vec_2<T> projecao_p ( const Vec_2<T> &v, const Vec_2<T> &v_proje );
template <class T> Vec_3<T> projecao_p ( const Vec_3<T> &v, const Vec_3<T> &v_proje );
template <class T> Vec_4<T> projecao_p ( const Vec_4<T> &v, const Vec_4<T> &v_proje );
...
template <class T> Vec_2<T> projecao_unitario_p ( const Vec_2<T> &v, const Vec_2<T> &v_proje_unitario );
template <class T> Vec_3<T> projecao_unitario_p ( const Vec_3<T> &v, const Vec_3<T> &v_proje_unitario );
template <class T> Vec_4<T> projecao_unitario_p ( const Vec_4<T> &v, const Vec_4<T> &v_proje_unitario );
...
/*===============================================================================================================================*/
template <class T>
Vec_2<T> projecao_p ( const Vec_2<T> &v, const Vec_2<T> &v_proje )
{
	return produto_escalar( v, v_proje ) / norma_quadrada( v_proje );
}
/*===============================================================================================================================*/
template <class T>
Vec_3<T> projecao_p ( const Vec_3<T> &v, const Vec_3<T> &v_proje )
{
	return produto_escalar( v, v_proje ) / norma_quadrada( v_proje );
}
/*===============================================================================================================================*/
template <class T>
Vec_4<T> projecao_p ( const Vec_4<T> &v, const Vec_4<T> &v_proje )
{
	return produto_escalar( v, v_proje ) / norma_quadrada( v_proje );
}
/*===============================================================================================================================*/
...
/*===============================================================================================================================*/
template <class T>
Vec_2<T> projecao_unitario_p ( const Vec_2<T> &v, const Vec_2<T> &v_proje_unitario )
{
	return produto_escalar( v, v_proje_unitario );
}
/*===============================================================================================================================*/
template <class T>
Vec_3<T> projecao_unitario_p ( const Vec_3<T> &v, const Vec_3<T> &v_proje_unitario )
{
	return produto_escalar( v, v_proje_unitario );
}
/*===============================================================================================================================*/
template <class T>
Vec_4<T> projecao_unitario_p ( const Vec_4<T> &v, const Vec_4<T> &v_proje_unitario )
{
	return produto_escalar( v, v_proje_unitario );
}
/*===============================================================================================================================*/
